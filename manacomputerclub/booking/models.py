...
class Order(models.Model):
    ...
    computers = models.ManyToManyField(Computers, blank=True, verbose_name="Компьютеры")
    services = models.CharField(max_length=50, default="Обычный зал 1ч.", verbose_name="Услуга")
    count_services = models.CharField(max_length=20,default='1', verbose_name="Количество услуг")
